...
IMGUI_IMPL_API bool     ImGui_ImplDX12_Init(ID3D12Device* device, ID3D12CommandQueue* cmdQueue, int num_frames_in_flight, DXGI_FORMAT rtv_format, ID3D12DescriptorHeap* srv_descriptor_heap, D3D12_CPU_DESCRIPTOR_HANDLE font_srv_cpu_desc_handle, D3D12_GPU_DESCRIPTOR_HANDLE font_srv_gpu_desc_handle);
#endif

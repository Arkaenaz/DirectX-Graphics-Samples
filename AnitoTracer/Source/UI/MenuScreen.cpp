...
void MenuScreen::drawUI()
{
	if (ImGui::BeginMainMenuBar())
	{
		...
		{
			UINames uiNames;
			if (ImGui::MenuItem("Hierarchy", "")) { UIManager::getInstance()->openWindow(uiNames.HIERARCHY_SCREEN); }
			if (ImGui::MenuItem("Inspector", "")) { UIManager::getInstance()->openWindow(uiNames.INSPECTOR_SCREEN); }
			if (ImGui::MenuItem("Profiler", "")) { UIManager::getInstance()->openWindow(uiNames.PROFILER_SCREEN); }
			if (ImGui::MenuItem("Color Picker", "")) { UIManager::getInstance()->openWindow(uiNames.COLOR_PICKER_SCREEN); }
		...
		{
			UINames uiNames;
			if (ImGui::MenuItem("Credits", "")) { UIManager::getInstance()->openWindow(uiNames.CREDITS_SCREEN); }

...
class LinearAllocatorProfiler
{
public:
	explicit LinearAllocatorProfiler(uint32 size)
		: m_pData(new char[size]), m_Size(size), m_Offset(0)
	{
	}

	~LinearAllocatorProfiler()
	{
		delete[] m_pData;
	}

	LinearAllocatorProfiler(LinearAllocatorProfiler&) = delete;
	LinearAllocatorProfiler& operator=(LinearAllocatorProfiler&) = delete;
...
public:
	...
	struct EventData
	{
		...
		LinearAllocatorProfiler					Allocator;			// Scratch allocator for frame
...
public:
	...
	struct EventData
	{
		...
		LinearAllocatorProfiler					Allocator;			// Scratch allocator storing all dynamic allocations of the frame
